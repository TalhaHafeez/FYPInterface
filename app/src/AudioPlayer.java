...
/**
 * Created by RABIA QAYYUM on 5/19/2018.
 */
...
public class AudioPlayer extends Service implements OnCompletionListener {
    ...
    private List<Song> tracks = new ArrayList<Song>(); // this collection should be encapsulated in another class.
    private songsList musicRepository = new songsList();
    ...
    public Song[] getQueuedTracks() {
        Song[] tracksArray = new Song[tracks.size()];
